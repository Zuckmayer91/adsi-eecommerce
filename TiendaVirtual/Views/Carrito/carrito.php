			...
			<div class="row">
				<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						<div class="wrap-table-shopping-cart">
							<table id="tblCarrito" class="table-shopping-cart">
								<tr class="table_head">
									...
									<th class="column-3">Precio Unitario</th>
									<th class="column-4">Cantidad en Unidad</th>
									<th class="column-5">Valor Total</th>
								</tr>
							<?php 
						...
						<!-- codigo para aplicar cupon de descuento en el carrito -- >
