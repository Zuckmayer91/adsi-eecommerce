      ...
      <ul class="app-menu">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <?php } ?>
				<?php if(!empty($_SESSION['permisos'][4]['Perm_read'])){ ?>
                <li><a class="treeview-item" href="<?= base_url(); ?>/productosvendidos"><i class="icon fa fa-circle-o"></i> Productos vendidos</a></li>
                <?php } ?>
        ...
        <li>
         ...
         <?php if(!empty($_SESSION['permisos'][11]['Perm_read'])){ ?>
        <li>
         ...
         <?php } ?>
		 <?php if(!empty($_SESSION['permisos'][10]['Perm_read'])){ ?>
        <li class="treeview">
            <a class="app-menu__item" href="#" data-toggle="treeview">
